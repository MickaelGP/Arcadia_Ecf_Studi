    ...
    <div class="container py-4 mt-5 shadow rounded">
        ...
        <form method="POST" action="{{route('gestion.animals.store')}}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control  @error('etat') is-invalid @enderror"  id="etat" name="etat" required>
                @error('etat')
            ...
            <div class="mb-3">
                <select class="form-select" name="race_id" id="raceSelect"
            ...
            <div class="mb-3">
                <select class="form-select" name="habitat_id" id="habitatSelect"
                    aria-label="Default select example">
